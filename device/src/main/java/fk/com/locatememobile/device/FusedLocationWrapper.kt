 ...
 */
class FusedLocationWrapper(applicationContext: Context,
                           private var fused: FusedLocationProviderClient = FusedLocationProviderClient(applicationContext)) : ObservableOnSubscribe<LocationResult> {
...
//                Repository.locationEndpoint.postUserLocation(Location(0, 1, System.currentTimeMillis(), locationResult.lastLocation.latitude, locationResult.lastLocation.longitude))
